...
public class ReadQTableClassContents {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        FileInputStream fi = new FileInputStream(new File("logfile-26-03-2020-2.properties"));
        ...
        try {
            mapper.writeValue(new File("rewards-26-03-2020-2.json"), rewards);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("electricityUsed-26-03-2020-2.json"), electricityUsedPerLoopPerHr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("tempAverages-26-03-2020-2.json"), tempAveragesPerLoopPerHr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("totalTimeHeating-26-03-2020-2.json"), totalTimeHeatingPerLoop);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
