...
public class ReadQTableClassContents {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        FileInputStream fi = new FileInputStream(new File("logfile-03-04-2020.properties"));
        ...
        try {
            mapper.writeValue(new File("rewards-03-04-2020.json"), rewards);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("electricityUsed-03-04-2020.json"), electricityUsedPerLoopPerHr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("tempAverages-03-04-2020.json"), tempAveragesPerLoopPerHr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mapper.writeValue(new File("totalTimeHeating-03-04-2020.json"), totalTimeHeatingPerLoop);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
